...
function RelationChip({ edge, slug, name }: { edge: RelationEdge; slug: string; name: string }) {
  const renderSide = (value: string) => {
    ...
    return (
      <Link
        ...
        className='rp-focus rounded-[3px] font-medium underline decoration-dotted underline-offset-2 transition-colors duration-150 hover:text-[var(--rp-ink)]'
  ...
  return (
    <div className='flex flex-wrap items-center gap-1.5 rounded-[6px] border border-line bg-surface px-3.5 py-2.5 text-sm text-ink-2'>
