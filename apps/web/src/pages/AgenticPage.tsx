...
// one surface (Assistant): the pipeline view lives there as a collapsible
// "Show the pipeline" disclosure under each answer instead. This route stays
// so old links/bookmarks keep working, and just forwards to Assistant.
// ---------------------------------------------------------------------------

export function AgenticPage() {
  const { config } = useOutletContext<TenantOutletContext>()
  return <Navigate to={`/t/${config.slug}/assistant`} replace />
}
