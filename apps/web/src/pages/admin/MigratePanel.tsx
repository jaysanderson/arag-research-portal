...
export function MigratePanel(
  ...
  return (
    <section className='rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm'>
      <h2 className='text-lg font-semibold tracking-tight text-neutral-900'>Migrate resources</h2>
      ...
      <div className='mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2'>
        ...
        <div>
          <label htmlFor='migrate-to' className='mb-1.5 block text-sm font-medium text-neutral-900'>
            To portal
          </label>
          <select
            id='migrate-to'
